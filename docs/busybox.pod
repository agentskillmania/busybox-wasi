...
Currently available applets include:
	...
	[, [[, arch, ascii, awk, base32, base64, basename, bc, bunzip2,
	bzcat, bzip2, cal, cat, chmod, chroot, cksum, cmp, comm, cp, cpio,
	crc32, cut, date, dc, dd, df, diff, dirname, dmesg, dos2unix, dpkg,
	dpkg-deb, du, echo, ed, egrep, env, expand, expr, factor, false,
	fgrep, fold, fsync, ftpget, ftpput, getopt, grep, groups, gunzip,
	gzip, hd, head, hexdump, install, link, ln, ls, lzcat, lzma, lzop,
	md5sum, mkdir, mkfifo, mktemp, mv, nc, netcat, nice, nl, nohup,
	nslookup, od, paste, patch, pipe_progress, printenv, printf, pwd,
	readlink, realpath, rev, rm, rmdir, rpm, rpm2cpio, run-parts, sed,
	seq, sha1sum, sha256sum, sha3sum, sha512sum, shred, shuf, sleep,
	sort, split, stat, strings, sum, sync, tac, tail, tar, tcpsvd, tee,
	telnet, test, timeout, touch, tr, true, truncate, tsort, tty,
	udpsvd, uname, unexpand, uniq, unix2dos, unlink, unlzma, unxz,
	unzip, usleep, uudecode, uuencode, vi, wc, wget, which, whois, wsh,
...
QUERY_TYPE: soa,ns,a,cname,mx,txt,ptr,srv,any
...
WASM shell for single-process environments
