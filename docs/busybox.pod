...
Currently available applets include:
	...
	fgrep, fold, fsync, getopt, grep, groups, gunzip, gzip, hd, head,
	hexdump, install, link, ln, ls, lzcat, lzma, lzop, md5sum, mkdir,
	mkfifo, mktemp, mv, nice, nl, nohup, od, paste, patch,
	pipe_progress, printenv, printf, pwd, readlink, realpath, resume,
	rev, rm, rmdir, rpm, rpm2cpio, run-parts, sed, seq, sha1sum,
	sha256sum, sha3sum, sha512sum, shred, shuf, sleep, sort, split,
	stat, strings, sum, sync, tac, tail, tar, tee, test, timeout, touch,
	tr, true, truncate, tsort, tty, uname, unexpand, uniq, unix2dos,
	unlink, unlzma, unxz, unzip, usleep, uudecode, uuencode, vi, wc,
	which, xxd, xz, xzcat, yes, zcat
