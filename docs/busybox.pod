...
Currently available applets include:
	...
	readlink, realpath, resume, rev, rm, rmdir, rpm, rpm2cpio,
	run-parts, sed, seq, sha1sum, sha256sum, sha3sum, sha512sum, shred,
	shuf, sleep, sort, split, stat, strings, sum, sync, tac, tail, tar,
	tcpsvd, tee, telnet, test, timeout, touch, tr, true, truncate,
	tsort, tty, udpsvd, uname, unexpand, uniq, unix2dos, unlink, unlzma,
	unxz, unzip, usleep, uudecode, uuencode, vi, wc, wget, which, whois,
