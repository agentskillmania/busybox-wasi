...
#define readlink_trivial_usage \
	IF_FEATURE_READLINK_FOLLOW("[-fnv] ") \
	IF_NOT_FEATURE_READLINK_FOLLOW("[-n] ") \
	"FILE" \
...
#define hwclock_trivial_usage \
       "[-ul] [-f DEV] [-s|-w|--systz|--param-get PARAM|--param-set PARAM=VAL]" \
